...
namehtml.append("and <strong id='unid'>{} unidentified names</strong>".format(len(recthtml) - len(namehtml)))
...
<header>
    ...
    reply to <a href="https://twitter.com/sil/status/1259520998967324672">this tweet</a> with the location (the number you get when mousing over a name).
</header>
<article>
<figure>
